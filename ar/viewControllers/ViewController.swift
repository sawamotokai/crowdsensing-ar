...
extension UIViewController {
    ...
    func showToast(message : String, color: UIColor) {
        ...
        let toastLabel = UILabel(frame: CGRect(x: self.view.frame.size.width/2 - 50, y: self.view.frame.size.height-100, width: self.view.frame.size.width-100, height: 35))
